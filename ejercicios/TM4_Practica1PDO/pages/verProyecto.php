        ...
        <div class="col-12">
            <div class="card my-4 shadow-lg">
                <div class="card-header p-3 bg-gradient-primary text-white">
                    <h6 class="text-white text-capitalize ps-3">Información del Proyecto</h6>
                </div>
                <div class="card-body">
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <div class="card border rounded-3">
                                <div class="card-body">
                                    <h6 class="card-title"><i class="fas fa-calendar-alt"></i> Fecha de Inicio</h6>
                                    <p class="card-text"><?php echo recuperarProyectoPorID($_GET['id'])["fechaInicio"]?></p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 mb-3">
                            <div class="card border rounded-3">
                                <div class="card-body">
                                    <h6 class="card-title"><i class="fas fa-calendar-check"></i> Fecha de Fin</h6>
                                    <p class="card-text"><?php echo recuperarProyectoPorID($_GET['id'])["fechaFin"]?></p>
                                </div>
                            </div>
                        </div>
                    </div>
