                ...
                <div class="col-12">
                    <div class="card mb-4 shadow-lg">
                        <div class="card-header border-0 text-black-50 text-center">
                            <h3>Reservas realizadas por <?= $_SESSION["usuario"]["email"] ?></h3>
                        </div>
                        <div class="card-body px-0 pt-0 pb-2">
                            <div class="table-responsive p-0">
                                <table class="table table-striped table-hover align-items-center mx-auto mb-0" style="width: 80%;"> <!-- Centrado de la tabla -->
                                    <thead>
                                    <tr>
                                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 text-center">Sala</th>
                                        ...
                                        <tr class="align-middle">
                                            <td class="align-middle text-start">
                                                <div class="d-flex px-2">
                                                    <div class="my-auto">
                                                        <h6 class="mb-0 text-sm"><?= $reserva->getNombreSala() ?></h6>
                                                    </div>
                                                </div>
                                            </td>
